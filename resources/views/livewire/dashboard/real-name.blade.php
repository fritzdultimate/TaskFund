            ...
            <form x-on:submit.prevent="setRealName" class="flex md:w-[70%] lg:w-[60%] xl:w-[50%] md:pt-[24px] p-[24px] bg-white rounded-[32px] flex-col items-start gap-4 text-slate-500 mx-auto">
                <div class="w-full">
                    <div class="flex flex-col gap-2 md:self-stretch w-full">
                        ...
                        <input x-model="realname" type="text" id="realname" name="realname" placeholder="Please Enter A Real Name" aria-label="real_name" aria-invalid="false" autocomplete="disabled" autocorrect="off" autocapitalize="off" class="md:py-[12px] py-1 px-6 rounded-3xl border border-white text-sm bg-[white!important] h-[48px]  ring-1 ring-blue-50 focus:!ring-2 focus:ring-blue-200 outline-none">
                        <p class="text-sm">
