...
@else
    <div class="flex flex-col items-center justify-center w-full h-full min-h-full"  wire:ignore.self>
        <div class="md:w-[490px] w-full flex flex-col justify-center items-center md:p-[32px] pb-3 rounded-2xl md:border-slate-300 md:border"  wire:ignore.self>
            <livewire:auth.otp :email="$login" :from="'login'" wire:key='otp'  wire:ignore.self>
        </div>
    </div>
@endif
